...
use Dflydev\DotAccessConfiguration\Data;
...
final class Configuration implements ConfigurationBuilderInterface, Config
{
        /**
         * @psalm-readonly
         */
    ...
    public function merge(array $config = []): void
    {
            ...
            $this->useConfig->import($config, DataInterface::REPLACE);
    }
    ...
    private function invalidate(): void
    {
        ...
        /**
         * Applies the schema against configuration to return the final configuration
         *
         * @throws ValidationException|UnkownOptionException|InvalidPathException
         *
         * @psalm-allow-private-mutation
         */
    private function build(string $topLevelKey): void
    {
        ...
        try {
                ...
                $processed = $processor->process(Except::structure([$topLevelKey => $schema]), $userData);
    ...
    private function raiseAnyDeprecationNotices(array $warnings): void
    {
        foreach ($warnings as $warning) {
                @\trigger_error($warning, \E - USER_DEPRECATED);
        }
    }
